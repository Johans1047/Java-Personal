...
public class Vendedor {
	...
	public void Vendedor(int vcantidad, double vsueldo, double vventa1, double vventa2, double vventa3) {
		cantidad = vcantidad;
		sueldo = vsueldo;
		venta1 = vventa1;
		venta2 = vventa2;
	...
	public static void main(String[] args) {
		...
		vr.Vendedor(vcantidad, vsueldo, vventa1, vventa2, vventa3);
		resultado = vr.CalcularComisiones();
		resultado2 = vr.CalcularTotal();
