...
public class Promedio {
	...
	public void Promedio(String vnombre, String vapellido, String vmateria, double vnota1, double vnota2, double vnota3) {
		nombre = vnombre;
		apellido = vapellido;
		materia = vmateria;
		nota1 = vnota1;
	...
	public static void main(String[] args) {
		...
		pr.Promedio(vnombre, vapellido, vmateria, vnota1, vnota2, vnota3);
		prom = pr.CalcularPromedio();
