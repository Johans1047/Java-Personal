...
public class Focos {
	...
	public void Focos(int vcantidad, int vcantidad2, int vverde, int vblanco, int vrojo) {
		cantidad = vcantidad;
	...
	public static void main(String[] args) {
		...
		fc.Focos(vcantidad, vcantidad2, vverde, vblanco, vrojo);
		resultado = fc.CalcularTotalFocos();
