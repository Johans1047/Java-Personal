...
public class Promedio3 {
	...
	public void Promedio3(String vnombre, String vapellido, String vmateria, double vnota1, double vnota2, double vnota3) {
		nombre = vnombre;
		apellido = vapellido;
		materia = vmateria;
		nota1 = vnota1;
	...
	public double CalcularPromedio3() {
		double promedio;
		promedio = 0.0;
	...
	public static void main(String[] args) {
		...
		pr.Promedio3(vnombre, vapellido, vmateria, vnota1, vnota2, vnota3);
		prom = pr.CalcularPromedio3();
