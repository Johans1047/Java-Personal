...
public class Focos2 {
	...
	public void Focos2(int vcantidad, int vcantidad2, int vverde, int vblanco, int vrojo) {
		cantidad = vcantidad;
	...
	public int CalcularTotalFocos2() {
		int total;
	...
	public static void main(String[] args) {
		...
		fc.Focos2(vcantidad, vcantidad2, vverde, vblanco, vrojo);
		resultado = fc.CalcularTotalFocos2();
